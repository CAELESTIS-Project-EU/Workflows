...
def workflow_execution(phases, parameters_yaml, inputs_yaml, outputs_yaml, execution_folder, data_folder):
    training_type, training_inputs, training_outputs, training_parameters = get_values(phases.get("training"), inputs_yaml, outputs_yaml,
    ...
    model, res = train.training(x, y, phases.get("training"))
