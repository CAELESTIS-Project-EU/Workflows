...
execution_id = "execution_7c1eea47-98fe-406b-8524-b32426e9e12a"
caseName = "FEM_OHT_nom"
sampleId = "s0"

jobName = caseName . "-" . sampleId
#pathJobFile = "/gpfs/projects/bsce81/alya/tests/workflow_stable/results/" . execution_id . "/execution/SIMULATIONS/" . jobName . "/" . jobName
...
plot "./base/1p/experiment.txt" using (1*$1):(1e-3*$2) title 'Experiment' with lines ls 1, \
     "./base/1p/Abaqus-".caseName.".txt" using (1*$1):($2) title 'Abaqus' with lines ls 2, \
     pathRefFile."-reaction.sld.res" using (1*$3):(1e-3*$6) title 'Reference' with lines ls 3, \
     pathJobFile."-reaction.sld.res" using (1*$3):(1e-3*$6) title 'Current job' with lines ls 4
