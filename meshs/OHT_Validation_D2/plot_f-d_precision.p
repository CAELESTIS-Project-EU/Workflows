...
#system("alya-sets fuse-boundary.sld.set 3")
#
...
plot "./base/1p/experiment.txt" using (1*$1):(1e-3*$2) title 'Experiment' with lines ls 1, \
     "./base/1p/abaqus.txt" using (1*$1):(1e-3*$2) title 'Abaqus' with lines ls 2, \
     "./base/1p/OHT_Validation_D2-reaction.sld.res" using (1*$3):(1e-3*$6) title 'Alya - Double precision' with lines ls 3, \
     "OHT_Validation_D2-reaction.sld.res" using (1*$3):(1e-3*$6) title 'Alya - Single precision' with lines ls 4
