...
# 	ol_right = 0.6
	...
	if tipo_fallo=="N":
		...
		datos_input, n_nodos, n_espesor, Ldom = NoFallos(w_tow, h_tow, L_pro, angles_tows, n_layers, n_tows, n_elements_gap, n_elements_towsingap, n_elements_layer)
	elif tipo_fallo=="O":
		caseName = "case_" + str(num_cases)
		datos_input, n_nodos, n_espesor, Ldom = Overlap(w_tow, h_tow, L_pro, ol, ajus_ol, ol_left, ol_right, angles_tows, n_layers, n_tows, n_elements_gap, n_elements_towsingap, n_elements_layer)
	elif tipo_fallo=="G":
		caseName = "Caso_" + str(num_cases)
		datos_input, n_nodos, n_espesor, Ldom = Gap(w_tow, h_tow, L_pro, ol, ajus_ol, ol_left, ol_right, angles_tows, n_layers, n_tows, n_elements_gap, n_elements_towsingap, n_elements_layer)
