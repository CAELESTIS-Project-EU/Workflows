...
def gen_model(x, y, training):
    ...
    x_block_size = (2, 2)  # Adjust based on your data and environment
    y_block_size = (2,)
    x_ds = ds.array(x, block_size=x_block_size)
    y_ds = ds.array(y, block_size=y_block_size)
    searcher.fit(x_ds, y_ds)
    print("RESULT")
