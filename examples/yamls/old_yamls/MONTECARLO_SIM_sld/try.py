...
def workflow(path, execution_folder, data_folder):
    with open(path) as f:
        ...
        phases = data.get("phases")
        workflow_execution(phases, data.get("parameters"), data.get("inputs"), data.get("outputs"), execution_folder,
                           data_folder)
    return
...
if __name__ == "__main__":
    path= "/home/rcecco/BSCprojects/templates_yaml/MONTECARLO_SIM_sld/OHT_Validation_D2.yaml" 
    execution_folder= "/home/rcecco/BSCprojects/templates_yaml/MONTECARLO_SIM_sld/OHT_Validation_D2.yaml" 
    data_folder= "/home/rcecco/BSCprojects/templates_yaml/MONTECARLO_SIM_sld/"
